...
func TestSetSetting(t *testing.T) {
	...
	exp := "red"
	ed.CommandHandler().RunTextCommand(v, "set_setting", lime.Args{"setting": "favorite_color", "value": exp})
