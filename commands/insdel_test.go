...
` {
	...
	ed.CommandHandler().RunTextCommand(v, "insert", lime.Args{"characters": "a"})
	...
	ed.CommandHandler().RunTextCommand(v, "insert", lime.Args{"characters": "\t"})
...
func TestInsert(t *testing.T) {
	...
	for i, test := range tests {
		...
		ed.CommandHandler().RunTextCommand(v, "insert", lime.Args{"characters": test.data})
...
func TestDeleteWord(t *testing.T) {
	...
	for i, test := range tests {
		...
		ed.CommandHandler().RunTextCommand(v, "delete_word", lime.Args{"forward": test.forward})
