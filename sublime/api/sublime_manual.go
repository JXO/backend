	...
	if v, err := tu.GetItem(0); err != nil {
		...
		if v3, err2 := fromPython(v); err2 != nil {
			...
			if v2, ok := v3.(string); !ok {
				return nil, fmt.Errorf("Expected type string for lime.DummyFrontend.ErrorMessage() arg1, not %s", v.Type())
			} else {
				arg1 = v2
			}
		}
	}
	lime.GetEditor().Frontend().ErrorMessage(arg1)
	return toPython(nil)
}
...
func sublime_MessageDialog(tu *py.Tuple) (py.Object, error) {
	...
	if v, err := tu.GetItem(0); err != nil {
		...
		if v3, err2 := fromPython(v); err2 != nil {
			...
			if v2, ok := v3.(string); !ok {
				return nil, fmt.Errorf("Expected type string for lime.DummyFrontend.MessageDialog() arg1, not %s", v.Type())
			} else {
				arg1 = v2
			}
		}
	}
	lime.GetEditor().Frontend().MessageDialog(arg1)
	return toPython(nil)
}
...
func sublime_OkCancelDialog(tu *py.Tuple) (py.Object, error) {
	...
	if v, err := tu.GetItem(0); err != nil {
		...
		if v3, err2 := fromPython(v); err2 != nil {
			...
			if v2, ok := v3.(string); !ok {
				return nil, fmt.Errorf("Expected type string for lime.DummyFrontend.OkCancelDialog() arg1, not %s", v.Type())
			} else {
				arg1 = v2
			}
		}
	...
	if v, err := tu.GetItem(1); err != nil {
		...
		if v3, err2 := fromPython(v); err2 != nil {
			...
			if v2, ok := v3.(string); !ok {
				return nil, fmt.Errorf("Expected type string for lime.DummyFrontend.OkCancelDialog() arg2, not %s", v.Type())
			} else {
				arg2 = v2
			}
		}
	}
	ret0 := lime.GetEditor().Frontend().OkCancelDialog(arg1, arg2)
	var err error
...
func sublime_StatusMessage(tu *py.Tuple) (py.Object, error) {
	...
	if v, err := tu.GetItem(0); err != nil {
		...
		if v3, err2 := fromPython(v); err2 != nil {
			...
			if v2, ok := v3.(string); !ok {
				return nil, fmt.Errorf("Expected type string for lime.DummyFrontend.StatusMessage() arg1, not %s", v.Type())
			} else {
				arg1 = v2
			}
		}
	}
	lime.GetEditor().Frontend().StatusMessage(arg1)
	return toPython(nil)
}
