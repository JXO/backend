...
func (view *View) Py_show(tu *py.Tuple, kw *py.Dict) (py.Object, error) {
	...
	lime.GetEditor().Frontend().Show(view.data, arg1)
	return toPython(nil)
}
...
func (o *View) Py_add_regions(tu *py.Tuple, kw *py.Dict) (py.Object, error) {
	...
	if v2, ok := v.(*py.Unicode); !ok {
		return nil, fmt.Errorf("Expected type *py.Unicode for lime.View.AddRegions() arg1, not %s", v.Type())
	} else {
		arg1 = v2.String()
	}
	v, err = tu.GetItem(1)
	...
	v2, ok := v.(*py.List)
	if !ok {
		return nil, fmt.Errorf("Expected type *py.List for lime.View.AddRegions() arg2, not %s", v.Type())
	}
	d := v2.Slice()
	...
	for i, o := range d {
		if v, err := fromPython(o); err != nil {
			...
			return nil, fmt.Errorf("Expected non-region item in list passed to lime.View.AddRegions(): %s", o.Type())
		} else {
			arg2[i] = v2
		}
	}
...
func (o *View) Py_command_history(tu *py.Tuple) (py.Object, error) {
	...
	if v2, ok := v.(*py.Long); !ok {
		return nil, fmt.Errorf("Expected type *py.Long for lime.View.CommandHistory() arg1, not %s", v.Type())
	} else {
		arg1 = int(v2.Int64())
	}
	if v, err := tu.GetItem(1); err == nil {
		if v2, ok := v.(*py.Bool); !ok {
			return nil, fmt.Errorf("Expected type *py.Bool for lime.View.CommandHistory() arg2, not %s", v.Type())
		} else {
			arg2 = v2.Bool()
		}
	}
...
func (o *View) Py_run_command(tu *py.Tuple) (py.Object, error) {
	...
	if v2, ok := v.(*py.Unicode); !ok {
		return nil, fmt.Errorf("Expected type *py.Unicode for lime.View.RunCommand() arg1, not %s", v.Type())
	} else {
		arg1 = v2.String()
	}
	arg2 = make(lime.Args)
	if v, err := tu.GetItem(1); err == nil {
		v2, ok := v.(*py.Dict)
		if !ok {
			return nil, fmt.Errorf("Expected type *py.Dict for lime.View.RunCommand() arg2, not %s", v.Type())
		}
	...
	lime.GetEditor().CommandHandler().RunTextCommand(o.data, arg1, arg2)
	return toPython(nil)
}

func (o *View) Py_visible_region() (py.Object, error) {
	ret0 := lime.GetEditor().Frontend().VisibleRegion(o.data)
	var err error
	var pyret0 py.Object
...
func (o *View) Py_expand_by_class(tu *py.Tuple, kw *py.Dict) (py.Object, error) {
	...
	if v, err := tu.GetItem(0); err != nil {
		...
		if v2, ok := v.(*Region); !ok {
			if v2, ok := v.(*py.Long); !ok {
				return nil, fmt.Errorf("Expected type *Region or *Int for lime.View.ExpandByClass() arg1, not %s", v.Type())
			} else {
				arg1.A = int(v2.Int64())
				arg1.B = arg1.A + 1
			}
	...
	if v, err := tu.GetItem(1); err != nil {
		...
		if v3, err2 := fromPython(v); err2 != nil {
			...
			if v2, ok := v3.(int); !ok {
				return nil, fmt.Errorf("Expected type int for lime.View.ExpandByClass() arg2, not %s", v.Type())
			} else {
				arg2 = v2
			}
		}
...
func (o *View) Py_find(tu *py.Tuple) (py.Object, error) {
	...
	if v, err := tu.GetItem(0); err != nil {
		...
		if v3, err2 := fromPython(v); err2 != nil {
			...
			if v2, ok := v3.(string); !ok {
				return nil, fmt.Errorf("Expected type string for lime.View.Find() arg1, not %s", v.Type())
			} else {
				arg1 = v2
			}
		}
	...
	if v, err := tu.GetItem(1); err != nil {
		...
		if v3, err2 := fromPython(v); err2 != nil {
			...
			if v2, ok := v3.(int); !ok {
				return nil, fmt.Errorf("Expected type int for lime.View.Find() arg2, not %s", v.Type())
			} else {
				arg2 = v2
			}
		}
	...
	if v, err := tu.GetItem(2); err == nil {
		if v3, err2 := fromPython(v); err2 != nil {
			...
			if v2, ok := v3.(int); !ok {
				return nil, fmt.Errorf("Expected type int for lime.View.Find() arg3, not %s", v.Type())
			} else {
				arg3 = v2
			}
		}
